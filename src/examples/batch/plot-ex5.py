...
n_samples, time_full, coverage_full, proc_counts_full, n_sites = readStatsFile("stats-ex5.json")
...
coords, dump_time, sites_full = readDumpFile("dump-ex5.json")
# number of species needs to be specified
#n_species = 1
#for i in sites:
...
for sid in range(n_samples):
    animateSnapshots(coords, dump_time[sid], sites_full[sid], "ex5.mp4")
