...
time_full, coverage_full, proc_counts_full, n_sites = readStatsFile("stats-ex2.json")
...
coords, dump_time, sites = readDumpFile("dump-ex2.json")
# number of species needs to be specified
n_species = 1
for i in sites:
...
animateSnapshots(coords, dump_time, sites, "ex2.mp4")